...
# kontener d1
docker run -itd --name d1 --net bridge1 --ip 10.0.10.254 alpine sh
...
# kontener s1dock
docker run -itd --name s1 --net bridge2 ubuntu sh

# kontener d2
docker run -itd --name d2 --net bridge1 -p 10.0.10.0:8080:80 -p 10.0.2.15:8081:80 busybox sh
